-- Migration: permitir vitaminB7, choline y chloride en la función de upsert de alimentos globales
BEGIN;
...
BEGIN
  ...
  -- Obtener o crear el alimento por nombre (case-insensitive, trimming)
